...
class MockEntitlementRepository implements IEntitlementRepository {
  ...
  async createOverride(): Promise<OverrideData> {
    return { id: "1", scope: "ORG", scopeId: "", featureKey: "", enabled: true, limitValue: null, expiresAt: null, reason: "" }
  }
  ...
  async getPlanWithFeatures() { return null }
  async getAllPlansWithFeatures() { return [] }
  async getFeatureWithPlans() { return null }
  async getAllFeaturesWithPlans() { return [] }
  async updatePlanFeature() { return { featureKey: "", featureName: "", enabled: false, limitValue: null, configJson: null, downgradeStrategy: "GRACEFUL" } }
  async createFeature() { return { id: "", key: "", name: "", description: null, type: "BOOLEAN" as FeatureType, defaultConfig: null } }
  async updateFeature() { return { id: "", key: "", name: "", description: null, type: "BOOLEAN" as FeatureType, defaultConfig: null } }
  async getDowngradePreview() { return { features: [], recommendedStrategy: "GRACEFUL" } }
  async isWebhookEventProcessed() { return false }
...
describe("FeatureGateService", () => {
  ...
  beforeEach(() => {
    ...
    mockRepo._setPlanFeatures("free", [
      { featureKey: "EXPORT_PDF", featureName: "Export PDF", enabled: false, limitValue: null, configJson: null, downgradeStrategy: "GRACEFUL" },
      { featureKey: "MAX_SYNCS", featureName: "Max Syncs", enabled: true, limitValue: 10, configJson: null, downgradeStrategy: "GRACEFUL" },
      { featureKey: "NEW_DASHBOARD", featureName: "New Dashboard", enabled: true, limitValue: null, configJson: { percentage: 50, seed: "NEW_DASHBOARD_v1" }, downgradeStrategy: "GRACEFUL" },
    ])
