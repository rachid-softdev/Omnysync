...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@omnysync/core/prisma": path.resolve(__dirname, "packages/omnysync-core/src/prisma/index.ts"),
      ...
      "@omnysync/core/entitlements": path.resolve(__dirname, "packages/omnysync-core/src/entitlements"),
      "@omnysync/core/crypto": path.resolve(__dirname, "packages/omnysync-core/src/crypto"),
      "@omnysync/core/subscriptions": path.resolve(__dirname, "packages/omnysync-core/src/subscriptions"),
      ...
      "react/jsx-runtime": path.resolve(__dirname, "omnysync-web/node_modules/react/jsx-runtime.js"),
      "react/jsx-dev-runtime": path.resolve(__dirname, "omnysync-web/node_modules/react/jsx-dev-runtime.js"),
      "react-dom": path.resolve(__dirname, "omnysync-web/node_modules/react-dom"),
      "react-dom/client": path.resolve(__dirname, "omnysync-web/node_modules/react-dom/client.js"),
      "react-dom/server": path.resolve(__dirname, "omnysync-web/node_modules/react-dom/server.js"),
    },
  },
});
