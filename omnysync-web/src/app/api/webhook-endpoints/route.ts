/**
 * Route API: Gestion des endpoints de webhook (collection)
 * GET /api/webhook-endpoints — Liste tous les webhooks de l'organisation
 * POST /api/webhook-endpoints — Crée un nouveau webhook
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('POST webhook-endpoints error:', error)
    return NextResponse.json({ error: 'Erreur serveur' }, { status: 500 })
  }
}
