...
- GET / â†’ **HTTP 200**.
  GET / renvoie HTTP 200. CORRIGE: globals.css importait 'shadcn/tailwind.css' inexistant et tailwindcss-animate non resolu -> 500. Deps ajoutees, import bogus retire.
