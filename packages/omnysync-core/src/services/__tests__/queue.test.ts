...
describe("Queue Service", () => {
  ...
  describe("addToDeadLetter", () => {
    it("should log the dead letter job", async () => {
      ...
      const job = { id: "job-1", type: "sync_document" as const, payload: { documentId: "doc-1" } };
  ...
  describe("processJobWithRetry", () => {
    ...
    it("should retry on failure and move to dead letter after max retries", { timeout: 20000 }, async () => {
      const processFn = vi.fn().mockRejectedValue(new Error("Network error"));
      const job = { id: "job-2", type: "sync_document" as const, payload: { documentId: "doc-2" } };
  ...
  describe("enqueueJob", () => {
    it("should publish a job to QStash", async () => {
      ...
      const job = { id: "", type: "sync_document" as const, payload: { documentId: "doc-1" } };
