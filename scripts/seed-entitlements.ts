...
const FEATURES = [
  // Boolean features
  { key: "EXPORT_PDF", name: "Export PDF", description: "Export documents as PDF", type: "BOOLEAN" as const },
  { key: "EXPORT_CSV", name: "Export CSV", description: "Export data as CSV", type: "BOOLEAN" as const },
  { key: "AI_SUMMARY", name: "AI Summary", description: "AI-powered content summarization", type: "BOOLEAN" as const },
  { key: "AI_SEO", name: "AI SEO", description: "AI-powered SEO optimization", type: "BOOLEAN" as const },
  { key: "AI_IMAGES", name: "AI Images", description: "AI-generated images", type: "BOOLEAN" as const },
  { key: "AI_INTERLINKING", name: "AI Interlinking", description: "AI-powered internal linking", type: "BOOLEAN" as const },
  { key: "TWO_WAY_SYNC", name: "Two-Way Sync", description: "Bidirectional content synchronization", type: "BOOLEAN" as const },
  { key: "APPROVAL_PORTAL", name: "Approval Portal", description: "Content approval workflow", type: "BOOLEAN" as const },
  { key: "CUSTOM_DOMAIN", name: "Custom Domain", description: "Use your own domain", type: "BOOLEAN" as const },
  { key: "API_ACCESS", name: "API Access", description: "Programmatic API access", type: "BOOLEAN" as const },
  { key: "PRIORITY_SUPPORT", name: "Priority Support", description: "Priority customer support", type: "BOOLEAN" as const },
  { key: "ANALYTICS_EXPORT", name: "Analytics Export", description: "Export analytics data", type: "BOOLEAN" as const },
  { key: "WEBHOOKS", name: "Webhooks", description: "Custom webhook integrations", type: "BOOLEAN" as const },
  { key: "SCHEDULED_SYNC", name: "Scheduled Sync", description: "Automated scheduled syncing", type: "BOOLEAN" as const },
  
  // Limit features
  { key: "MAX_CONNECTORS", name: "Max Connectors", description: "Maximum number of connectors", type: "LIMIT" as const, defaultConfig: { max: 100 } },
  { key: "MAX_DOCUMENTS", name: "Max Documents", description: "Maximum number of documents", type: "LIMIT" as const, defaultConfig: { max: 10000 } },
  { key: "MAX_SYNCS_PER_MONTH", name: "Max Syncs/Month", description: "Maximum syncs per month", type: "LIMIT" as const, defaultConfig: { max: 1000 } },
  { key: "MAX_TEAM_MEMBERS", name: "Max Team Members", description: "Maximum team members", type: "LIMIT" as const, defaultConfig: { max: 50 } },
  { key: "MAX_API_CALLS", name: "Max API Calls", description: "Maximum API calls per month", type: "LIMIT" as const, defaultConfig: { max: 100000 } },
  
  // Experiment features
  { key: "NEW_DASHBOARD", name: "New Dashboard", description: "Redesigned dashboard experience", type: "EXPERIMENT" as const, defaultConfig: { percentage: 50, seed: "NEW_DASHBOARD_v1" } },
  { key: "AI_V2", name: "AI V2", description: "Next generation AI features", type: "EXPERIMENT" as const, defaultConfig: { percentage: 25, seed: "AI_V2_2026" } },
]

const PLAN_FEATURES: Record<string, Record<string, { enabled: boolean; limitValue: number | null; configJson: object | null }>> = {
  free: {
  ...
  pro: {
    ...
    NEW_DASHBOARD: { enabled: true, limitValue: null, configJson: { percentage: 50, seed: "NEW_DASHBOARD_v1" } },
    AI_V2: { enabled: false, limitValue: null, configJson: null },
  },
  business: {
    EXPORT_PDF: { enabled: true, limitValue: null, configJson: null },
  ...
  enterprise: {
    ...
    NEW_DASHBOARD: { enabled: true, limitValue: null, configJson: { percentage: 100, seed: "NEW_DASHBOARD_v1" } },
