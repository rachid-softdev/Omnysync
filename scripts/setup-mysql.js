...
console.log('🗄️  Setting up MySQL for Omnysync...\n');
...
function createDatabase() {
  try {
    ...
    const createDbCommand = `mysql -u root -pazerty123 -e "CREATE DATABASE IF NOT EXISTS omnysync; SHOW DATABASES;"`;
    execSync(createDbCommand, { stdio: 'inherit' });

    console.log('✅ Database "omnysync" created successfully');
    return true;
  } catch (error) {
...
function main() {
  console.log('🚀 MySQL Setup for Omnysync\n');
